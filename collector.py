"""Headless V3.4.5 collector for cron / Windows Task Scheduler.
...
def main():
    ...
    # V3.4.5: populate the research funnel even in headless scheduled runs. Standing probes
    ...
    save_alerts(alerts)
    print(f"Saved V3.4.5 snapshot #{rid} | phase={scores['phase']} | confidence={scores['confidence']:.0f}/100")
